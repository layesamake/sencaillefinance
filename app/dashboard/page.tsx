    ...
    return (
        <main className="min-h-[100dvh] bg-background text-slate-50 pb-24 font-sans">
            ...
            <nav className="fixed bottom-6 left-1/2 -translate-x-1/2 z-40 bg-surface/90 backdrop-blur-xl border border-slate-800/50 px-4 py-2 flex items-center justify-between w-[92%] max-w-sm rounded-full shadow-2xl">
                <button className="p-3 text-emerald-400 flex items-center justify-center transition-transform active:scale-95" aria-label="Accueil">
                    <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                        <path strokeLinecap="round" strokeLinejoin="round" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
                    </svg>
                </button>
                <button className="p-3 text-slate-400 hover:text-slate-200 flex items-center justify-center transition-transform active:scale-95" aria-label="Historique">
                    <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                ...
                <div className="relative -top-5">
                    <button className="w-14 h-14 bg-emerald-500 rounded-full flex items-center justify-center text-slate-950 shadow-[0_8px_30px_rgb(16,185,129,0.3)] transition-transform active:scale-95 hover:bg-emerald-400" aria-label="Saisir">
                ...
                <button className="p-3 text-slate-400 hover:text-slate-200 flex items-center justify-center transition-transform active:scale-95" aria-label="Rapports">
                    <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                ...
                <form action={handleSignOut} className="flex">
                    <button type="submit" className="p-3 text-slate-400 hover:text-rose-400 flex items-center justify-center transition-colors active:scale-95" aria-label="Déconnexion">
                        <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
