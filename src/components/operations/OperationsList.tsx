...
export default function OperationsList({ operations }: OperationsListProps) {
  ...
  if (operations.length === 0) {
    return (
      <div className="text-center py-12 bg-gray-900 border border-gray-800 rounded-3xl mt-6">
        ...
        <p className="text-gray-400">Aucune opération trouvée avec ces filtres.</p>
      </div>
    );
  }
